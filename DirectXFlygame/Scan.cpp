//an inclusive prefix sum (or scan )
//max of 16384 elements can be scanned
//uint2 is the scan type, see hlsl file to change
...
HRESULT CScanCS::OnD3D11CreateDevice( ID3D11Device* pd3dDevice)
{
	...
	V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\ScanCS.hlsl", NULL, "CSScanInBucket", "cs_4_0", &pBlobCS) );
    ...
    V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\ScanCS.hlsl", NULL, "CSScanBucketResult", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\ScanCS.hlsl", NULL, "CSScanAddBucketResult", "cs_4_0", &pBlobCS ) );

...
ID3D11ComputeShader* Tessellator::s_pEdgeFactorCS = NULL;
ID3D11ComputeShader* Tessellator::s_pNumVerticesIndicesCSs[] = { NULL, NULL, NULL };
ID3D11ComputeShader* Tessellator::s_pScatterVertexTriIDIndexIDCS = NULL;
ID3D11ComputeShader* Tessellator::s_pScatterIndexTriIDIndexIDCS = NULL;
ID3D11ComputeShader* Tessellator::s_pTessVerticesCSs[] = {NULL, NULL, NULL, NULL};
ID3D11ComputeShader* Tessellator::s_pTessIndicesCSs[] = {NULL, NULL, NULL, NULL};
ID3D11Buffer* Tessellator:: s_pEdgeFactorCSCB = NULL;
ID3D11Buffer* Tessellator:: s_pLookupTableCSCB = NULL;
ID3D11Buffer* Tessellator:: s_pCSCB = NULL;
ID3D11Buffer* Tessellator::s_pCSReadBackBuf = NULL;

CScanCS Tessellator::s_ScanCS;
...
void Tessellator::DeleteDeviceObjects()
{
...
HRESULT Tessellator::OnD3D11CreateDevice( ID3D11Device* pd3dDevice )
{
    HRESULT hr = S_OK;
...
void Tessellator::OnDestroyDevice()
{
...
HRESULT Tessellator::OnD3D11ResizedSwapChain( ID3D11Device* pd3dDevice, const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc )
{
...
void Tessellator::SetPartitioningMode( PARTITIONING_MODE mode )
{
    m_PartitioningMode = mode;
}

HRESULT Tessellator::CreateCSForPartitioningMode( PARTITIONING_MODE mode, 
                                                   ID3D11ComputeShader** pNumVerticesIndicesCS, ID3D11ComputeShader** pTessVerticesCS, ID3D11ComputeShader** pTessIndicesCS )
{
    ...
    V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_NumVerticesIndicesCS.hlsl", define, "CSNumVerticesIndices", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_TessellateVerticesCS.hlsl", define, "CSTessellationVertices", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_TessellateIndicesCS.hlsl", define, "CSTessellationIndices", "cs_4_0", &pBlobCS ) );
...
HRESULT Tessellator::SetBaseMesh( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dImmediateContext, 
                                   INT nVertices,
                                   ID3D11Buffer* pBaseVB )
{
    ...
    if ( s_pEdgeFactorCS == NULL )
    {
        ...
        ID3DBlob* pBlobCS = NULL;
        V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_EdgeFactorCS.hlsl", NULL, "CSEdgeFactor", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_ScatterIDCS.hlsl", NULL, "CSScatterVertexTriIDIndexID", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"..\\DirectXSamples\\AdaptiveTessellationCS40\\TessellatorCS40_ScatterIDCS.hlsl", NULL, "CSScatterIndexTriIDIndexID", "cs_4_0", &pBlobCS ) );
...
void Tessellator::PerEdgeTessellation( D3DXMATRIX* matWVP,

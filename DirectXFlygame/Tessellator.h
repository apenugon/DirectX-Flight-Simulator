//Tessellator; based on the TessellatorCS40 created by Microsoft in the Adaptive Tessellation DirectX Sample
#ifndef _TESSELATOR_H
#define _TESSELATOR_H
#include "DXUT.h"
...
public:
	...
	HRESULT SetBaseMesh( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dImmediateContext, INT nVertices, ID3D11Buffer* pBaseVB);
	...
	void PerEdgeTessellation( D3DXMATRIX* matWVP, ID3D11Buffer** ppTessedVerticesBuf, ID3D11Buffer** ppTessedIndicesBuf, DWORD* num_tessed_vertices, DWORD* num_tessed_indices);
...
private:
	...
	HRESULT CreateCSForPartitioningMode(PARTITIONING_MODE mode, ID3D11ComputeShader** pNumVerticesIndicesCS, ID3D11ComputeShader** pTessVerticesCS, ID3D11ComputeShader** pTessIndicesCS );
